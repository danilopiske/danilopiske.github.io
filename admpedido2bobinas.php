...
<link rel="icon" href="">
<title>Administrar Pedidos de Bobinas</title>
...
?>
<h2><strong>Administrar Pedidos de Bobinas</strong></h2>
...
<form enctype="multipart/form-data" action="procpedido.php" method="post" class="container-fluid">
  ...
  <tr>
  <td><input type="hidden" name="test" class="form-control" value="admpedido2bobinas" required></td>
  </tr>
