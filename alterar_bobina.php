...
<form enctype="multipart/form-data" method="post" action="processa.php">
  ...
  <tr>
  <td>Bobina</td>
  <td><input name="codi" type="text" class="form-control" size="100%width"  maxlength="14" value="<?php echo $codi ?>" required></td>
  <td><input name="clie" type="hidden" class="form-control" size="100%width"  maxlength="14" value="<?php echo $_POST["clie"] ?>" required></td>
  </tr>
  <tr>
  <td><input type="hidden" name="test" class="form-control" value="altbobina" required></td>
  </tr>
  <tr>
