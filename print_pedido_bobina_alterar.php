...
<?php
	...
	include("./includes/conexao.php");
			...
			try { 
			         ...
			         $comandoSQL = "UPDATE pedbobina SET `vexb` = '$vexb', `ccod` = '$ccod', `cnom` = '$cnom', `craz` = '$craz', `cend` = '$cend', `cbai` = '$cbai', `ccid` = '$ccid', `cuf` = '$cuf', `ccep` = '$ccep', `ccnp` = '$ccnp', `cies` = '$cies', `cte1` = '$cte1' , `cema` = '$cema', `ccon` = '$ccon',  `bobi` = '$bobi', `bvia` = '$bvia', `bpap` = '$bpap', `nume` = '$nume', `core` = '$core', `loca` = '$loca', `qtcx` = '$qtcx', `valu` = '$valu', `valt` = '$valt', `praz` = '$praz', `tran` = '$tran', `arte` = '$arte', `obse` = '$obse', `aimg` = '$aimg' WHERE `pedbobina`.`pedi` = $pedi";
