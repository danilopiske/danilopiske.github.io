...
?>
<strong><a href="index_administrativo.php"><img src="images/logo.jpg" alt="" width="166" height="112"></a><h2>Consultador</strong>
</h2>
<form enctype="multipart/form-data" method="post" action="consultar_2.php">
