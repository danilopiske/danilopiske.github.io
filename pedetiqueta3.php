...
<form enctype="multipart/form-data" action="print_pedido_etiqueta.php" method="post" class="container-fluid">
  ...
  <td><select name="etiq" id="etiq" required> 
  <option value="">Selecione o Produto</option>
  <?php
    $bobi = $pdo->prepare("SELECT * FROM cadetiqueta");
    $bobi->execute();
  ...
  <td><input type="text" name="ebal" id="ebal" class="form-control" style="width:100%" required></td>
  <td nowrap=true><h4>Tipo de Papel</h4></td>
  <td><input type="text" name="epap" id="epap" class="form-control" required></td>
  </tr>
  ...
  <td><input type="text" name="qtrl" class="form-control" style="width:100%" required></td>
