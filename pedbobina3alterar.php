...
<form enctype="multipart/form-data" action="print_pedido_bobina_alterar.php" method="post" class="container-fluid">
  ...
  <td colspan="5"><input type="text" name="vexb" id="vexb" class="form-control" style="width:100%" value="<?php echo $vexb?>" readonly required></td></td>
  <td><h4>Data:</h4></td>
  ...
  <tr>
  <td><h4>Bobina</h4></td>
  <td colspan="10"><input type="text" name="bobi" class="form-control" style="width:100%" value="<?php echo $bobi ?>" required></td>
  <td nowrap=true><h4>Nº de Vias</h4></td>
  <td><input type="text" name="bvia" class="form-control" style="width:100%" value="<?php echo $vias ?>" required></td>
  <td nowrap=true><h4>Tipo de Papel</h4></td>
  <td><input type="text" name="bpap" class="form-control" value="<?php echo $pape ?>" required></td>
  </tr>
  ...
  <td><input type="text" name="qtcx" class="form-control" style="width:100%" value="<?php echo $qtcx ?>" required></td>
  <td nowrap=true><h4>Valor Unitário</h4></td>
  <td><input type="text" name="valu" class="form-control" style="width:100%" value="<?php echo $valu ?>" required></td>
  </tr>
  
  <tr>
  <td nowrap=true><h4>Valor Total</h4></td>
  <td><input type="text" name="valt" class="form-control" style="width:100%" value="<?php echo $valt ?>" required></td>
  ...
  <td colspan="9"><input type="text" name="obse" class="form-control" style="width:100%" value="<?php echo $obse ?>" required></td>
  </tr>
  
  <tr>
  <td nowrap= "true"><h4>Imagem</h4></td>
